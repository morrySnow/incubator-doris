...
public class TlsOptionsTest {
    ...
    @Test
    public void testAnalyzeAcceptsValidEntries() throws AnalysisException {
        ...
        tlsOptions.analyze();
        Assert.assertEquals("email:alice@example.com, DNS:example.com, URI:spiffe://example.com/workload, IP Address:192.168.1.1",
                tlsOptions.getSan());
    }
}
