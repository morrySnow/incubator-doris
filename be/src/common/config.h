...
// enable s3/object storage client cache
DECLARE_mBool(enable_obj_storage_client_cache);
DECLARE_mBool(aws_client_disable_imds);
...
DECLARE_mInt32(aws_client_low_speed_limit);
