...
public:
    ...
    // NOTE: hubspot CLucene doesn't have norm() in TermDocs
    // Original: return term_docs_->norm();
    MOCK_FUNCTION int32_t norm() const { return 1; }
    ...
    static TermIterPtr create(const io::IOContext* io_ctx, bool is_similarity,
        ...
        // Original: make_term_doc_ptr(reader, t.get(), is_similarity, io_ctx);
        auto term_docs = make_term_doc_ptr(reader, t.get(), io_ctx);
