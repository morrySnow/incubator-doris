...
TEST_F(MultiPhraseQueryV2Test, test_multi_phrase_query_with_scoring) {
    ...
    // SCORING DISABLED: context->collection_statistics->_total_num_docs = reader_holder->numDocs();
    // SCORING DISABLED: context->collection_statistics->_total_num_tokens[field] = reader_holder->numDocs() * 8;
    // SCORING DISABLED: context->collection_statistics->_term_doc_freqs[field][StringHelper::to_wstring("quick")] = 10;
    // SCORING DISABLED: context->collection_statistics->_term_doc_freqs[field][StringHelper::to_wstring("fast")] = 5;
    // SCORING DISABLED: context->collection_statistics->_term_doc_freqs[field][StringHelper::to_wstring("brown")] = 10;
...
TEST_F(MultiPhraseQueryV2Test, test_multi_phrase_query_bm25_similarity) {
    ...
    // SCORING DISABLED: context->collection_statistics->_term_doc_freqs[field][StringHelper::to_wstring("fast")] = 5;
    // SCORING DISABLED: context->collection_statistics->_term_doc_freqs[field][StringHelper::to_wstring("brown")] = 10;
    // SCORING DISABLED: context->collection_statistics->_term_doc_freqs[field][StringHelper::to_wstring("fox")] = 8;
    // SCORING DISABLED: context->collection_statistics->_term_doc_freqs[field][StringHelper::to_wstring("dog")] = 8;
