...
TEST_F(PhraseQueryV2Test, test_phrase_query_bm25_similarity) {
    ...
    // SCORING DISABLED: Setup statistics for BM25
    // SCORING DISABLED: context->collection_statistics->_total_num_docs = reader_holder->numDocs();
    // SCORING DISABLED: context->collection_statistics->_total_num_tokens[field] = reader_holder->numDocs() * 8;
    // SCORING DISABLED: for (const auto& term : terms) {
    // SCORING DISABLED:     context->collection_statistics->_term_doc_freqs[field][term] = 5;
    // SCORING DISABLED: }
